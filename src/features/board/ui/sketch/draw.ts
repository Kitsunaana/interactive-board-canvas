import type { ShapeToView, SketchShapeProperties } from "@/features/board/domain/_shape.ts";
...
function drawSketchShape({ hachureFill, hachureLines, layerOffsets, outlines, strokeColor }: SketchShapeProperties) {
  context.save()
